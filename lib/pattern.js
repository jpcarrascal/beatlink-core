...
// Dual-environment export: this file is also served to browsers at
// /beatlink/pattern.js (see createServer) so clients can mirror the grid
// with the exact same semantics the server enforces.
if (typeof module === 'object' && module && typeof module.exports === 'object') {
    module.exports = { Pattern };
} else if (typeof window !== 'undefined') {
    window.beatlink = window.beatlink || {};
    window.beatlink.Pattern = Pattern;
}
